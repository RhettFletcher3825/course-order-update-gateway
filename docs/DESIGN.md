...
> Design notes for **course-order-update-gateway** — a runnable typescript example that A typed course-commerce service that routes receipt-ready order updates through an OpenAI-compatible gateway.
...
- **Feature code** — the actual task: course-order-updates.
